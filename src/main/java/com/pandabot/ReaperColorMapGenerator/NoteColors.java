...
public class NoteColors {
   ...
   public final static Color tonicNote = new Color(180, 225, 205);
   public final static Color regularNote = new Color(230, 244, 203);
   public final static Color fourthScaleNote = new Color(180, 205, 226);
   ...
   public final static Color maxVelocityNote = new Color(250, 180, 175);
